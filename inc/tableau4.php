...
$query = "SELECT * FROM recettes_douanieres ORDER BY nature_droits_taxes, annee";
...
<div class="card">
    <div class="card-header bg-success text-white text-center">
        <h5 class="mb-0">Tableau 4. Recettes douanières (En milliards d’Ariary)</h5>
    </div>
