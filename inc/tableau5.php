...
$query = "SELECT * FROM recettes_non_fiscales ORDER BY type_recette, annee";
...
<div class="card">
    <div class="card-header bg-success text-white text-center">
        <h5 class="mb-0">Tableau 5. Recettes Non Fiscales (En milliards d’Ariary)</h5>
    </div>
